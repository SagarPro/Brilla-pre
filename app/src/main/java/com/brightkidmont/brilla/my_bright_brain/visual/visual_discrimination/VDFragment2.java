...
public class VDFragment2 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getContext()).load(imageList.get(2)).error(R.drawable.bright_kid_bg).into(image1);
        Picasso.with(getContext()).load(imageList.get(2)).error(R.drawable.bright_kid_bg).into(image2);
        Picasso.with(getContext()).load(imageList.get(2)).error(R.drawable.bright_kid_bg).into(image3);
        Picasso.with(getContext()).load(imageList.get(2)).error(R.drawable.bright_kid_bg).into(image4);
        Picasso.with(getContext()).load(imageList.get(2)).error(R.drawable.bright_kid_bg).into(image5);
        Picasso.with(getContext()).load(imageList.get(3)).error(R.drawable.bright_kid_bg).into(image6);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.image6:
                ...
                Picasso.with(getContext()).load(resultList.get(1)).placeholder(image6.getDrawable()).into(image6);
                correct.start();
                break;
        }
        hideView();
