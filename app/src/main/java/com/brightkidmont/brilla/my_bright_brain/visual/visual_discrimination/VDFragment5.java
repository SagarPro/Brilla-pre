...
public class VDFragment5 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getContext()).load(imageList.get(8)).error(R.drawable.bright_kid_bg).into(image1);
        Picasso.with(getContext()).load(imageList.get(8)).error(R.drawable.bright_kid_bg).into(image2);
        Picasso.with(getContext()).load(imageList.get(8)).error(R.drawable.bright_kid_bg).into(image3);
        Picasso.with(getContext()).load(imageList.get(9)).error(R.drawable.bright_kid_bg).into(image4);
        Picasso.with(getContext()).load(imageList.get(8)).error(R.drawable.bright_kid_bg).into(image5);
        Picasso.with(getContext()).load(imageList.get(8)).error(R.drawable.bright_kid_bg).into(image6);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.image4:
                ...
                Picasso.with(getContext()).load(resultList.get(4)).placeholder(image4.getDrawable()).into(image4);
                correct.start();
                break;
            case R.id.image5:
                ivResult.setImageResource(R.drawable.wrong);
