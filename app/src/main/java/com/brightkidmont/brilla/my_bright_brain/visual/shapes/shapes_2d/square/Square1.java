...
public class Square1 extends Fragment implements View.OnClickListener{

    private ImageView ivCircleResult, ivRectangleResult, ivSquareResult, ivTriangleResult;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.square1, container, false);

        TextView flash_header = (TextView) view.findViewById(R.id.flash_header);
        flash_header.setText("Select the Square");
        ...
        ImageView ivSquare = (ImageView) view.findViewById(R.id.ivSquare);
        ...
        Picasso.with(getContext()).load(image3).error(R.drawable.bright_kid_bg).into(ivSquare);
        ...
        ivSquareResult = (ImageView) view.findViewById(R.id.ivSquareResult);
        ...
        ivSquareResult.setVisibility(View.GONE);
        ...
        if(!q.isPlaying() && !wrong.isPlaying()) {
            switch (id) {
                ...
                case R.id.ivRectangle:
                    ...
                    break;
                case R.id.ivSquare:
                    ivSquareResult.setVisibility(View.VISIBLE);
                    correct.start();
                    hideView();
                    break;
