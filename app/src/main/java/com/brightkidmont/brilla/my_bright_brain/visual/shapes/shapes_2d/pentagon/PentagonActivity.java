...
public class PentagonActivity extends AppCompatActivity {
    ...
    public static String pentagonTab;
    private int i = 0, p = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pentagon_layout);
        ...
        q = MediaPlayer.create(getBaseContext(), R.raw.pentagon1);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                pentagonTab = tab.getText().toString();
                switch (pentagonTab){
                    case "1":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.pentagon1);
                    ...
                    case "4":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.pentagon4);
                        break;
                    case "5":
                        stopAllAudio();
                    ...
                    case "6":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.pentagon6);
                        break;
                }
                q.start();
                p = tab.getPosition()+1;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Pentagon1(), "1");
        adapter.addFrag(new Pentagon2(), "2");
        adapter.addFrag(new Pentagon3(), "3");
        adapter.addFrag(new Pentagon4(), "4");
        adapter.addFrag(new Pentagon5(), "5");
        adapter.addFrag(new Pentagon6(), "6");
