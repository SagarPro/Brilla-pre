...
public class OvalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oval_layout);
        ...
        q = MediaPlayer.create(getBaseContext(), R.raw.oval1);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (ovalTab){
                    ...
                    case "4":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.oval4);
                        break;
                    case "5":
                        stopAllAudio();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Oval1(), "1");
        adapter.addFrag(new Oval2(), "2");
        adapter.addFrag(new Oval3(), "3");
        adapter.addFrag(new Oval4(), "4");
        adapter.addFrag(new Oval5(), "5");
        adapter.addFrag(new Oval6(), "6");
