...
public class Pentagon5 extends Fragment {

    private int pentagonId;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.pentagon5, container, false);
        ...
        image4 = "https://firebasestorage.googleapis.com/v0/b/brilla-47f1f.appspot.com/o/Shapes%2Fpentagon.png?alt=media&token=32911db7-0479-481c-9072-84d9818a1fc8";
        ...
        Picasso.with(getContext()).load(image4).error(R.drawable.bright_kid_bg).into(pentagon);

        pentagonId = pentagon.getId();
        ...
        pentagon.setOnTouchListener(new MyTouchListener());

        LinearLayout empty_pentagon = (LinearLayout) view.findViewById(R.id.empty_pentagon);
        empty_pentagon.setOnDragListener(new MyDragListener());
