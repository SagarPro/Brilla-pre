...
public class BlueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.setBackgroundColor(getResources().getColor(R.color.fbutton_color_belize_hole));
        tabLayout.setTabMode(TabLayout.MODE_FIXED);
        tabLayout.setupWithViewPager(viewPager);

        q = MediaPlayer.create(getBaseContext(), R.raw.blue1);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (blueTab) {
                    ...
                    case "2":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.blue2);
                        break;
                    case "3":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.blue3);
                        count=0;
                        valid="not";
                        break;
                    case "4":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.blue4);
                        break;
                    case "5":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.blue5);
                        break;
                }
                q.start();
                p = tab.getPosition()+1;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Blue1(), "1");
        adapter.addFrag(new Blue2(), "2");
        adapter.addFrag(new Blue3(), "3");
        adapter.addFrag(new Blue4(), "4");
        adapter.addFrag(new Blue5(), "5");
