...
public class RectangleActivity extends AppCompatActivity {
    ...
    public static String rectangleTab;
    private int i = 0, p = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q = MediaPlayer.create(getBaseContext(), R.raw.rectangle1);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                rectangleTab = tab.getText().toString();
                switch (rectangleTab){
                    case "1":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.rectangle1);
                    ...
                    case "4":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.rectangle4);
                        break;
                    case "5":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.rectangle5);
                        break;
                    case "6":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.rectangle6);
                        break;
                }
                q.start();
                p = tab.getPosition()+1;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Rectangle1(), "1");
        adapter.addFrag(new Rectangle2(), "2");
        adapter.addFrag(new Rectangle3(), "3");
        adapter.addFrag(new Rectangle4(), "4");
        adapter.addFrag(new Rectangle5(), "5");
        adapter.addFrag(new Rectangle6(), "6");
