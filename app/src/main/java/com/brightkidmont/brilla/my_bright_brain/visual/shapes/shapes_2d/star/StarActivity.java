...
public class StarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q = MediaPlayer.create(getBaseContext(), R.raw.star2);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (starTab){
                    ...
                    case "2":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.star1);
                        break;
                    case "3":
                        stopAllAudio();
                    ...
                    case "4":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.star4);
                        break;
                    case "5":
                        stopAllAudio();
                    ...
                    case "7":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.star7);
                        break;
                }
                q.start();
                p = tab.getPosition()+1;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Star2(), "1");
        adapter.addFrag(new Star1(), "2");
        adapter.addFrag(new Star3(), "3");
        adapter.addFrag(new Star4(), "4");
        adapter.addFrag(new Star5(), "5");
        adapter.addFrag(new Star6(), "6");
        adapter.addFrag(new Star7(), "7");
