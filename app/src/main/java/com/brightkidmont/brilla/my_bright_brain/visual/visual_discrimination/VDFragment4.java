...
public class VDFragment4 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getContext()).load(imageList.get(7)).error(R.drawable.bright_kid_bg).into(image1);
        Picasso.with(getContext()).load(imageList.get(6)).error(R.drawable.bright_kid_bg).into(image2);
        Picasso.with(getContext()).load(imageList.get(6)).error(R.drawable.bright_kid_bg).into(image3);
        Picasso.with(getContext()).load(imageList.get(6)).error(R.drawable.bright_kid_bg).into(image4);
        Picasso.with(getContext()).load(imageList.get(6)).error(R.drawable.bright_kid_bg).into(image5);
        Picasso.with(getContext()).load(imageList.get(6)).error(R.drawable.bright_kid_bg).into(image6);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.image1:
                ...
                Picasso.with(getContext()).load(resultList.get(3)).placeholder(image1.getDrawable()).into(image1);
                correct.start();
                break;
            case R.id.image2:
