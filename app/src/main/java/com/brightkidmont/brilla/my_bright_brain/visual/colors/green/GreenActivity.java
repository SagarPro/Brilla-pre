...
public class GreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.setBackgroundColor(getResources().getColor(R.color.fbutton_color_emerald));
        tabLayout.setTabMode(TabLayout.MODE_FIXED);
        tabLayout.setupWithViewPager(viewPager);

        q = MediaPlayer.create(getBaseContext(), R.raw.green1);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (greenTab) {
                    ...
                    case "2":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.green2);
                        break;
                    case "3":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.green3);
                        break;
                    case "4":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.green4);
                        count=0;
                        valid="not";
                        break;
                    case "5":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.green5);
                        count=0;
                        valid="not";
                        break;
                }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Green1(), "1");
        adapter.addFrag(new Green2(), "2");
        adapter.addFrag(new Green3(), "3");
        adapter.addFrag(new Green4(), "4");
        adapter.addFrag(new Green5(), "5");
