...
public class Rectangle1 extends Fragment implements View.OnClickListener{

    private ImageView ivCircleWrong,ivRectangleRight, ivStarWrong, ivTriangleWrong;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.rectangle1, container, false);

        TextView flash_header = (TextView) view.findViewById(R.id.flash_header);
        flash_header.setText("Identify the rectangle");
        ...
        ivRectangleRight= (ImageView) view.findViewById(R.id.ivRectangleRight);
        ...
        ivRectangleRight.setVisibility(View.GONE);
        ...
        if(!q.isPlaying() && !wrong.isPlaying()) {
            switch (id) {
                ...
                case R.id.ivRectangle:
                    ivRectangleRight.setVisibility(View.VISIBLE);
                    correct.start();
                    hideView();
                    break;
                case R.id.ivStar:
