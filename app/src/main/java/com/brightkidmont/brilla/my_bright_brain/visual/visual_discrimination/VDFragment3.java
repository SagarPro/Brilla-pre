...
public class VDFragment3 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //setting images into imageView
        Picasso.with(getContext()).load(imageList.get(4)).error(R.drawable.bright_kid_bg).into(image1);
        Picasso.with(getContext()).load(imageList.get(5)).error(R.drawable.bright_kid_bg).into(image2);
        Picasso.with(getContext()).load(imageList.get(4)).error(R.drawable.bright_kid_bg).into(image3);
        Picasso.with(getContext()).load(imageList.get(4)).error(R.drawable.bright_kid_bg).into(image4);
        Picasso.with(getContext()).load(imageList.get(4)).error(R.drawable.bright_kid_bg).into(image5);
        Picasso.with(getContext()).load(imageList.get(4)).error(R.drawable.bright_kid_bg).into(image6);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.image2:
                ...
                Picasso.with(getContext()).load(resultList.get(2)).placeholder(image2.getDrawable()).into(image2);
                correct.start();
                break;
            case R.id.image3:
                ivResult.setImageResource(R.drawable.wrong);
