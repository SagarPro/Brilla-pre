...
public class TrapeziumActivity extends AppCompatActivity {

    public static String trapeziumTab;
    private int i = 0, p = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trapezium_layout);
        ...
        q = MediaPlayer.create(getBaseContext(), R.raw.trapezium1);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                trapeziumTab = tab.getText().toString();
                switch (trapeziumTab){
                    case "1":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.trapezium1);
                    ...
                    case "3":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.trapezium3);
                        break;
                    case "4":
                        stopAllAudio();
                    ...
                    case "5":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.trapezium5);
                        break;
                    case "6":
                        stopAllAudio();
                    ...
                    case "7":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.trapezium7);
                        break;
                }
                q.start();
                p = tab.getPosition()+1;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Trapezium1(), "1");
        adapter.addFrag(new Trapezium2(), "2");
        adapter.addFrag(new Trapezium3(), "3");
        adapter.addFrag(new Trapezium4(), "4");
        adapter.addFrag(new Trapezium5(), "5");
        adapter.addFrag(new Trapezium6(), "6");
        adapter.addFrag(new Trapezium7(), "7");
