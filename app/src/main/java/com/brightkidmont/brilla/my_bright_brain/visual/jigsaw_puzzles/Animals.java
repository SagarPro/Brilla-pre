...
public class Animals extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //setting image into imageView from database
        for(int i=0; i<4; i++){
            Picasso.with(getContext()).load(jpImages.get(i)).error(R.drawable.bright_kid_bg).into(imageList.get(i));
            imageList.get(i).setOnTouchListener(new MyTouchListener());
        }
    ...
    private void validate(){
        if(lltl.getChildCount()==1
            ...
            Picasso.with(getContext()).load(jpFull.get(0)).into(ivBG);
    ...
    //class to load image to set in background
