...
public class TriangleActivity extends AppCompatActivity {
    ...
    public static String triangleTab;
    private int i = 0, p = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q = MediaPlayer.create(getBaseContext(), R.raw.triangle1);
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                triangleTab = tab.getText().toString();
                switch (triangleTab){
                    case "1":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.triangle1);
                    ...
                    case "2":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.triangle2);
                        break;
                    case "3":
                        stopAllAudio();
                    ...
                    case "4":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.triangle4);
                        break;
                    case "5":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.triangle5);
                        break;
                    case "6":
                        stopAllAudio();
                    ...
                    case "7":
                        stopAllAudio();
                        q = MediaPlayer.create(getBaseContext(), R.raw.triangle7);
                        break;
                }
                q.start();
                p = tab.getPosition()+1;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Triangle1(), "1");
        adapter.addFrag(new Triangle2(), "2");
        adapter.addFrag(new Triangle3(), "3");
        adapter.addFrag(new Triangle4(), "4");
        adapter.addFrag(new Triangle5(), "5");
        adapter.addFrag(new Triangle6(), "6");
        adapter.addFrag(new Triangle7(), "7");
